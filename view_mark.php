        ...
        <div id="container">
           <?php
            ...
            <div id="link_bar" class="font_label">
               ...
               <a href="view_mark.php"><div id="a_add_student" class="font_home"><font color="brick"><center>View Mark</center></font></div></a>
          ...
          <center>  <div id="content"><font color="brickred"face="ariel"><b><i><h2>welcome <?php echo $name; ?></h2></i></b></font>
                  <div id="content1"class="font_title">
                      <center> <h7>your mark Detials</h7><br><br></center>
                      <font size="3" color="white"><center> <table width="500"height="auto" border="0">
                         <?php
                          $con = mysqli_connect("localhost", "root", "", "student");
            $un1 = mysqli_query($con,"select * from mark where name='$name'") or die(mysql_error());
            $ro=mysqli_fetch_array($un1);
                          ?>
                              ...
                              <tr>
                                  <td width="250">Physics</td>
                                  <td/>: <?php echo $ro["m1"]?> </td>
                              </tr>
                              <tr>
                                  <td>Chemistry</td>
                                  <td>: <?php echo $ro["m2"]?> </td>
                              </tr>
                              <tr>
                                  <td>Maths</td>
                                  <td>: <?php echo $ro["m3"]?> </td>
                              </tr>
                              
                              <tr>
                                  <td>Total Mark</td>
                                  <td>: <?php echo $ro["mark"]?> </td>
                              </tr>
