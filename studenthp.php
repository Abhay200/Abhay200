        ...
        <div id="container">
           <?php
            ...
            <div id="link_bar" class="font_label">
               <a href="studenthp.php"><div id="a_home" class="font_home"><font color="brick"><center>Home</center></font></div></a>
          ...
          <center>  <div id="content"><font color="brickred"face="ariel"><b><i><h2>welcome <?php echo $name; ?></h2></i></b></font>
                  <div id="content1"class="font_title"><center> <h7>your personal Detials</h7><br><br></center>
                      <font size="3" color="white"><center> <table width="500"height="auto" border="0">
                         <?php
                          $con = mysqli_connect("localhost", "root", "", "student");
            $un1 = mysqli_query($con,"select * from register where name='$name'") or die(mysql_error());
            $ro=mysqli_fetch_array($un1);
                ...
                <div id="content2"><br><br><center><img width="500"height="300" src="images/6.jpg"></center></div>
            </div> </center><br>
