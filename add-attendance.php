    ...
    <body>
        <div id="container">Admin In
            ...
            <div id="link_bar" class="font_label">
               ...
               <a href="add-attendance.php"><div id="a_add_attendence" class="font_home"><font color="brick"><center>Add attendence</center></font></div></a>
            ...
            <div id="content">
                 ...
                 <div id="content1"><font color="white"><center><br>
                    <table width="500"border="0">
                        ...
                        <?php
                        $un1 = mysqli_query($con,"select * from attendance") or die(mysql_error());
                        ...
                        while ($ro = mysqli_fetch_array($un1)) {
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center" width="250"><?php echo $ro['attendance'] ?></td>
...
?>                 
                ...
                <form method="POST"> <center><h7 style=" font-size: 30px;font-family:Impact;"><br><font color="blue">ADD ATTENDANCE</font></h7></center><hr>
                   <center> <table class="table_font" border="0">
                    ...
                    <tr>
                            <td align="center" ><br>
                                <input class="new" type="submit" name="add-at" value="Add"/>
                            </td>
                     </tr>
                     <tr>
                            <td align="center" ><br>
        ...
        <?php 
  if(isset($_POST["add-at"])){
            $n=$_POST["name"];
            $ma=$_POST["attendance"];
            //mysql_connect("localhost","root","");
                   $un2 = mysqli_query($con, "select * from attendance where name='$n'") or die(mysql_error());
    if (mysqli_num_rows($un2) == 0) {       
                  
                 
             mysqli_query($con, "insert into attendance values(id,'$n',$ma)") or die(mysql_error());
                }
 else {
                    echo "error";
 }
